...
SeekBar.OnSeekBarChangeListener{
    ...
    @Override
  	public boolean onCreateOptionsMenu(Menu menu) {
  		...
  		//int id=ResourceUtil.getDrawableId(getApplicationContext(), "ic_launcher");
  		//if(id==0)return false;
  		//Drawable dw=getApplicationContext().getDrawable(id);
  		menu.add(Menu.NONE,Menu.FIRST+1,1,"悬浮窗权限");
  		menu.add(Menu.NONE,Menu.FIRST+2,2,"官网");
  		menu.add(Menu.NONE,Menu.FIRST+3,3,"计算埋雷数据");
  		return true;
  	}
