...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="8.33";//插件版本号
	public static final String PLUGIN_NAME="qqputthunder.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.qqputthunder";//插件名字；
	...
	public static final String PREFERENCE_NAME = "byc_qqputthunder_config";//配置文件名称
    ...
    public static String contact="QQ：1339524332微信：x52088802";//联系方式
